      ...
      .then(responseJson =>{
        ...
        this.setState({
          ...
          let inter = setInterval(()=>{
            this.setState({
              timeToDirect: this.state.timeToDirect-1
            }, ()=>{
              if(this.state.timeToDirect == 0){
                clearInterval(inter);
                hashHistory.push('/')
              }
            })
  ...
  render(){
    if (this.state.sent){
      return <div className="row text-center">
        <h1>Thank You from your order</h1>
        <p>You will be redirect in {this.state.timeToDirect}</p>
      </div>
    }
      ...
      <div className="col-md-12 col-sm-12">
        ...
        <form onSubmit={this.handleFormSubmit}>
            ...
            <div className="col-md-6">
                  ...
                  <div className="col-md-12 form-group">
                    <button type="submit"
                      className="btn btn-warning pull-right">Confirm</button>
                  </div>
            </div>
